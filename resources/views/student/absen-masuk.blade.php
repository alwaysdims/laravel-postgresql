@extends('student.layouts.main',['title' => 'Student absen masuk'])
@section('content')
...
<div class="card">
    ...
    <div class="card-body">
        ...
        <label for="photo-absen" class="form-label d-block text-center cursor-pointer">
            <span class="badge bg-primary fs-6 mb-2">Ambil Foto untuk Absen Masuk</span>
        </label>

        <form action="{{ route('absen.masuk.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <button type="submit" class="btn btn-success btn-lg w-100">
                <i class="bx bx-check-circle me-1"></i> Konfirmasi Absen Masuk
            </button>
        </form>
        ...
        <div class="alert alert-info" role="alert">
            ...
            <p class="mb-0">
                Foto yang diunggah akan digunakan sebagai bukti kehadiran. Pastikan perangkat Anda mengizinkan akses kamera dan lokasi. Absen masuk hanya valid pada jam 05:00 WIB hingga 08:00 WIB.
            </p>
        </div>
    </div>
</div>
